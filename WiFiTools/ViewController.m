...
@property(nonatomic, strong) NSString *currentConnBSSID;
@end
...
//    [WiFiTools callCommandline];
    ...
    self.currentConnBSSID = [WiFiTools currentNetworkBSSID];
...
- (NSView *)tableView:(NSTableView *)tableView viewForTableColumn:(NSTableColumn *)tableColumn row:(NSInteger)row{
    ...
    if([tableColumn.identifier isEqualToString:@"SSIDColumn"]){
        ...
        if([self.currentConnBSSID isEqualToString:model.bssid]){
